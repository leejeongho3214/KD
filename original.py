...
if __name__ == "__main__":
    ...
    for epoch in range(250):
        ...
        print("\rRemaing time is %dh  %dm   %ds" % (check_time / 3600, (check_time % 3600) / 60, (check_time % 60)))
        ...
        with torch.no_grad():
            ...
            if correct / total < best_acc:
                count += 1
                print("\rDon't upgrade accuracy (%d/10)" % count)
                if count == 30:
                    break
            else:
                count = 0
                best_acc = correct / total
                print("\r%d Epoch Test AccuracyAcc:  %.4f%%  " % (epoch+1, (100 * best_acc)))
                torch.save(net.state_dict(), "./checkpoint/" + args.model + "2.pth")
